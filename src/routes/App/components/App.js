  ...
  return (
    <div className={`app${isDarkMode ? " dark-mode" : ""}`}>
      <div className="level">
        ...
        <button className="app__dark-mode-btn icon level-right" onClick={e => setIsDarkMode(!isDarkMode)}>
          <FontAwesomeIcon icon={isDarkMode ? faSun : faMoon} color={isDarkMode ? "#FFA500" : ""}/>
        </button>
